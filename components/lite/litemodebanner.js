...
export default function LiteModeBanner() {
  ...
  useEffect(() => {
    ...
    setLiteUrl(`https://cmoon.sumit.info.np${currentPath}`);
  }, [pathname]);
  ...
  return (
    <div className="bg-amber-500/10 border-b border-amber-500/20 z-100  text-amber-200/90 text-xs md:text-sm py-2 px-4 flex justify-between items-center gap-2">
      <div className="w-full text-center">
        <span>Want full features? </span>
        <a
          href={liteUrl}
